...
function get_header_for_exc( $name = null ) {
	/**
	 * Fires before the header template file is loaded.
	 *
	 * The hook allows a specific header template file to be used in place of the
	 ...
	 * @param string $name Name of the specific header file to use.
	 */
	do_action( 'get_header_for_exc', $name );
	...
	$templates[] = 'header_for_exc.php';

	locate_template( $templates, true );
}
function get_header_for_special_offers( $name = null ) {
	/**
	 * Fires before the header template file is loaded.
	 *
	 * The hook allows a specific header template file to be used in place of the
	 ...
	 * @param string $name Name of the specific header file to use.
	 */
	do_action( 'get_header_for_special_offers', $name );
	...
	$templates[] = 'header_for_special_offers.php';

	locate_template( $templates, true );
}
function get_header_for_about( $name = null ) {
	/**
	 * Fires before the header template file is loaded.
	 *
	 * The hook allows a specific header template file to be used in place of the
	 ...
	 * @param string $name Name of the specific header file to use.
	 */
	do_action( 'get_header_for_about', $name );
	...
	$templates[] = 'header_for_about.php';

	locate_template( $templates, true );
}
function get_header_for_book( $name = null ) {
	/**
	 * Fires before the header template file is loaded.
	 *
	 * The hook allows a specific header template file to be used in place of the
	 ...
	 * @param string $name Name of the specific header file to use.
	 */
	do_action( 'get_header_for_book', $name );
	...
	$templates[] = 'header_for_book.php';

	locate_template( $templates, true );
}
function get_header_for_contacts( $name = null ) {
	/**
	 * Fires before the header template file is loaded.
	 *
	 * The hook allows a specific header template file to be used in place of the
	 ...
	 * @param string $name Name of the specific header file to use.
	 */
	do_action( 'get_header_for_contacts', $name );
	...
	$templates[] = 'header_for_contacts.php';

	locate_template( $templates, true );
}
function get_header_for_thanks( $name = null ) {
	/**
	 * Fires before the header template file is loaded.
	 *
	 * The hook allows a specific header template file to be used in place of the
	 ...
	 * @param string $name Name of the specific header file to use.
	 */
	do_action( 'get_header_for_thanks', $name );
	...
	$templates[] = 'header_for_thanks.php';

	locate_template( $templates, true );
}
function get_header_for_404( $name = null ) {
	/**
	 * Fires before the header template file is loaded.
	 *
	 * The hook allows a specific header template file to be used in place of the
	 ...
	 * @param string $name Name of the specific header file to use.
	 */
	do_action( 'get_header_for_404', $name );
	...
	$templates[] = 'header_for_404.php';

	locate_template( $templates, true );
}
function get_header_for_hot( $name = null ) {
	/**
	 * Fires before the header template file is loaded.
	 *
	 * The hook allows a specific header template file to be used in place of the
	 ...
	 * @param string $name Name of the specific header file to use.
	 */
	do_action( 'get_header_for_hot', $name );
	...
	$templates[] = 'header_for_hot.php';

	locate_template( $templates, true );
}
function get_header_for_reviews( $name = null ) {
	/**
	 * Fires before the header template file is loaded.
	 *
	 * The hook allows a specific header template file to be used in place of the
	 ...
	 * @param string $name Name of the specific header file to use.
	 */
	do_action( 'get_header_for_reviews', $name );
	...
	$templates[] = 'header_for_reviews.php';
...
function get_footer_for_exc( $name = null ) {
	/**
	 * Fires before the footer template file is loaded.
	 *
	 * The hook allows a specific footer template file to be used in place of the
	 ...
	 * @param string $name Name of the specific footer file to use.
	 */
	do_action( 'get_footer_for_exc', $name );
	...
	$templates[]    = 'footer_for_exc.php';

	locate_template( $templates, true );
}
function get_footer_for_special_offers( $name = null ) {
	/**
	 * Fires before the footer template file is loaded.
	 *
	 * The hook allows a specific footer template file to be used in place of the
	 ...
	 * @param string $name Name of the specific footer file to use.
	 */
	do_action( 'get_footer_for_special_offers', $name );
	...
	$templates[]    = 'footer_for_special_offers.php';

	locate_template( $templates, true );
}
function get_footer_for_about( $name = null ) {
	/**
	 * Fires before the footer template file is loaded.
	 *
	 * The hook allows a specific footer template file to be used in place of the
	 ...
	 * @param string $name Name of the specific footer file to use.
	 */
	do_action( 'get_footer_for_about', $name );
	...
	$templates[]    = 'footer_for_about.php';

	locate_template( $templates, true );
}
function get_footer_for_book( $name = null ) {
	/**
	 * Fires before the footer template file is loaded.
	 *
	 * The hook allows a specific footer template file to be used in place of the
	 ...
	 * @param string $name Name of the specific footer file to use.
	 */
	do_action( 'get_footer_for_book', $name );
	...
	$templates[]    = 'footer_for_book.php';

	locate_template( $templates, true );
}
function get_footer_for_contacts( $name = null ) {
	/**
	 * Fires before the footer template file is loaded.
	 *
	 * The hook allows a specific footer template file to be used in place of the
	 ...
	 * @param string $name Name of the specific footer file to use.
	 */
	do_action( 'get_footer_for_contacts', $name );
	...
	$templates[]    = 'footer_for_contacts.php';

	locate_template( $templates, true );
}
function get_footer_for_thanks( $name = null ) {
	/**
	 * Fires before the footer template file is loaded.
	 *
	 * The hook allows a specific footer template file to be used in place of the
	 ...
	 * @param string $name Name of the specific footer file to use.
	 */
	do_action( 'get_footer_for_thanks', $name );
	...
	$templates[]    = 'footer_for_thanks.php';

	locate_template( $templates, true );
}
function get_footer_for_404( $name = null ) {
	/**
	 * Fires before the footer template file is loaded.
	 *
	 * The hook allows a specific footer template file to be used in place of the
	 ...
	 * @param string $name Name of the specific footer file to use.
	 */
	do_action( 'get_footer_for_404', $name );
	...
	$templates[]    = 'footer_for_404.php';

	locate_template( $templates, true );
}
function get_footer_for_hot( $name = null ) {
	/**
	 * Fires before the footer template file is loaded.
	 *
	 * The hook allows a specific footer template file to be used in place of the
	 ...
	 * @param string $name Name of the specific footer file to use.
	 */
	do_action( 'get_footer_for_hot', $name );
	...
	$templates[]    = 'footer_for_hot.php';

	locate_template( $templates, true );
}
function get_footer_for_reviews( $name = null ) {
	/**
	 * Fires before the footer template file is loaded.
	 *
	 * The hook allows a specific footer template file to be used in place of the
	 ...
	 * @param string $name Name of the specific footer file to use.
	 */
	do_action( 'get_footer_for_reviews', $name );
	...
	$templates[]    = 'footer_for_reviews.php';

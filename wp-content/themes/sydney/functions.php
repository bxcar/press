...
/*** Микроразметка в комментариях ***/function schema_comment($comment, $args, $depth){
	...
	<div itemprop="comment" itemscope="itemscope" itemtype="http://schema.org/Comment">
		...
		<div class="comment-meta commentmetadata" itemprop="datePublished">
			<?php
			/* translators: 1: date, 2: time */printf( __( '%1$s' ), get_comment_date('Y-m-d')); ?><?php edit_comment_link( __( '(Edit)' ), '&nbsp;&nbsp;', '' );
			?>
		</div>

...
<head>
    <title>Спецпредложения - Coral Travel (Борисполь)</title>
    <meta name="description" content="Специальные предложения на отдых для одного, для двоих, для всей семьи от Coral Travel в Борисполе">
